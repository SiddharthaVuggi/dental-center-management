...
const PatientTable = () => {
  ...
  return (
    <div className="patient-add">
      ...
      <h3>{editingId ? "Edit Patient Details" : "Add Patient Details"}</h3>
      ...
      <ul>
        {patients.map((patient) => (
          <li key={patient.id}>
            <strong>{patient.name}</strong> | {patient.contact}
